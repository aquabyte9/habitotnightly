...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Habitot is a kinder control panel for your day.",
      },
      ...
      { name: "theme-color", content: "#f3b464" },
      { name: "application-name", content: "Habitot" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Habitot" },
